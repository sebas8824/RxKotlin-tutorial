...
class ReactiveCalculator(a: Int, b: Int) {
    ...
    /* The function uses the suspend keyword, because we tell the compiler that this function
    * will take longer than it should and the execution context calling this function will wait
